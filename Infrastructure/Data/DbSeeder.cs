    ...
    public class DbSeeder
    {
        public static async Task SeedAsync(LibraryContext context)
        {
            ...
            if (!context.Books.Any())
            {
                ...
                var book1 = new Book(11111, "The Great Gatsby", "A story of the fabulously wealthy Jay Gatsby", 180, "Fiction", new List<Author> { author1 });
                var book2 = new Book(22222, "Tender Is the Night", "A psychological novel set on the French Riviera", 320, "Fiction", new List<Author> { author1 });
                var book3 = new Book(33333, "Pride and Prejudice", "A romantic novel following Elizabeth Bennet", 432, "Romance", new List<Author> { author2 });
                var book4 = new Book(44444, "Sense and Sensibility", "A story of the Dashwood sisters navigating love and society", 368, "Romance", new List<Author> { author2 });
                var book5 = new Book(55555, "Emma", "A comedy of manners following the well-meaning but misguided Emma Woodhouse", 400, "Romance", new List<Author> { author2 });
                var book6 = new Book(66666, "1984", "A dystopian novel set in a totalitarian society under Big Brother", 328, "Dystopian", new List<Author> { author3 });
                var book7 = new Book(77777, "Animal Farm", "An allegorical novella reflecting events leading up to the Russian Revolution", 112, "Satire", new List<Author> { author3 });
                var book8 = new Book(88888, "The Old Man and the Sea", "An aging fisherman struggles with a giant marlin far out in the Gulf Stream", 127, "Fiction", new List<Author> { author4 });
                var book9 = new Book(99999, "A Farewell to Arms", "A love story set against the backdrop of World War I", 332, "Historical Fiction", new List<Author> { author4 });
                var book10 = new Book(10101, "For Whom the Bell Tolls", "An American fights with Republican guerrillas in the Spanish Civil War", 480, "Historical Fiction", new List<Author> { author4 });
                var book11 = new Book(11011, "Mrs Dalloway", "A day in the life of Clarissa Dalloway in post-World War I England", 194, "Modernist", new List<Author> { author5 });
                var book12 = new Book(12012, "To the Lighthouse", "A family visits their summer home on the Isle of Skye", 209, "Modernist", new List<Author> { author5 });
                var book13 = new Book(13013, "The Waves", "Six characters speak their inner thoughts as they grow from childhood to old age", 256, "Modernist", new List<Author> { author5 });
            ...
            {
                var borrower1 = new Borrower("Magnus", "Jensen", 8000, "Aarhus", "Midtjylland", "Åboulevarden", "12", "12345678");
                var borrower2 = new Borrower("Sofia", "Nielsen", 2100, "København", "Hovedstaden", "Østerbrogade", "45B", "87654321");
                var borrower3 = new Borrower("Lucas", "Andersen", 5000, "Odense", "Syddanmark", "Vestergade", "7", "11223344");
                var borrower4 = new Borrower("Emma", "Christensen", 9000, "Aalborg", "Nordjylland", "Boulevarden", "23", "44332211");
